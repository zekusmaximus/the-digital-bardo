...
function getGuardian() {
  console.log('[DataFlowGuardian] getGuardian called');
  if (!guardianInstance) {
...
export function initializeDataGuardian(consciousnessInstance) {
  ...
  console.log('[DataFlowGuardian] Got guardian:', guardian);
...
export function logDataFlow(source, destination, data) {
  console.log('[DataFlowGuardian] logDataFlow function called with:', { source, destination, data: data ?? '(no data)' });
  const guardian = getGuardian();
...
export function auditDataBoundaries() {
  console.log('[DataFlowGuardian] auditDataBoundaries function called');
  const guardian = getGuardian();
